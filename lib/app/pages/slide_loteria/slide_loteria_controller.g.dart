...
part of 'slide_loteria_controller.dart';

// **************************************************************************
// InjectionGenerator
// **************************************************************************

final $SlideLoteriaController = BindInject(
  (i) => SlideLoteriaController(),
  singleton: true,
  lazy: true,
);
...
mixin _$SlideLoteriaController on _SlideImageControllerBase, Store {
